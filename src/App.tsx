...
{showEqPanel&&(
      ...
      <div style={{position:'relative' as const,zIndex:1,width:'100%',display:'flex',alignItems:'center',justifyContent:'space-between',flexShrink:0,marginTop:8,marginBottom:8,animation:'slideUp 0.35s cubic-bezier(0.25,0.46,0.45,0.94) 0.18s both'}}>
      ...
      {/* Громкость */}
      <div style={{position:'relative' as const,zIndex:1,width:'100%',display:'flex',alignItems:'center',gap:10,flexShrink:0,marginBottom:6,animation:'slideUp 0.35s cubic-bezier(0.25,0.46,0.45,0.94) 0.22s both',pointerEvents:volSliderEnabled?'auto':'none' as const,opacity:volSliderEnabled?1:0.7}}>
      ...
      <div style={{position:'relative' as const,zIndex:1,width:'100%',display:'flex',justifyContent:'space-around',alignItems:'center',flexShrink:0,marginBottom:8,paddingBottom:'env(safe-area-inset-bottom)',animation:'slideUp 0.35s cubic-bezier(0.25,0.46,0.45,0.94) 0.26s both'}}>
