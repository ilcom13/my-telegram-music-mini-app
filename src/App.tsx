...
<div key={tr.id+i} style={{display:'flex',alignItems:'center',gap:8,padding:'8px 0',borderBottom:'1px solid #2a2a2a',transition:'background 0.15s ease'}}>
      ...
      <div style={{position:'relative' as const,zIndex:1,width:'100%',display:'grid',gridTemplateColumns:'1fr auto 1fr',alignItems:'center',paddingTop:18,paddingBottom:10}}>
      ...
      <div style={{flex:'0.6 1 0',minHeight:8}}/>
      <div style={{position:'relative' as const,zIndex:1,width:'100%',display:'flex',justifyContent:'center',marginTop:0,marginBottom:0}}>
        <div
        ...
        >
          <Img src={current.cover} size={Math.min(window.innerWidth-60, window.innerHeight*0.28, 320)} radius={0}/>
        </div>
      </div>
      <div style={{flex:'1 1 0',minHeight:8}}/>
      <div style={{position:'relative' as const,zIndex:1,width:'100%',display:'flex',alignItems:'center',justifyContent:'space-between',gap:14,marginBottom:8,animation:'slideUp 0.35s cubic-bezier(0.25,0.46,0.45,0.94) 0.05s both'}}>
        <div style={{flex:1,minWidth:0}}>
...
{showEqPanel&&(
      ...
      <div style={{width:'100%',marginBottom:2,animation:'slideUp 0.35s cubic-bezier(0.25,0.46,0.45,0.94) 0.15s both'}}>
      ...
      <div style={{position:'relative' as const,zIndex:1,width:'100%',display:'flex',alignItems:'center',justifyContent:'space-between',marginTop:8,marginBottom:8,animation:'slideUp 0.35s cubic-bezier(0.25,0.46,0.45,0.94) 0.18s both'}}>
      ...
      {/* Громкость */}
      <div style={{position:'relative' as const,zIndex:1,width:'100%',display:'flex',alignItems:'center',gap:10,marginBottom:6,animation:'slideUp 0.35s cubic-bezier(0.25,0.46,0.45,0.94) 0.22s both',pointerEvents:volSliderEnabled?'auto':'none' as const,opacity:volSliderEnabled?1:0.7}}>
      ...
      <div style={{flex:'0.5 1 0',minHeight:6}}/>

      {/* Нижний ряд: Playlists / Queue / Share */}
      <div style={{position:'relative' as const,zIndex:1,width:'100%',display:'flex',justifyContent:'space-around',alignItems:'center',marginBottom:8,paddingBottom:'env(safe-area-inset-bottom)',animation:'slideUp 0.35s cubic-bezier(0.25,0.46,0.45,0.94) 0.26s both'}}>
